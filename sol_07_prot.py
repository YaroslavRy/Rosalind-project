...
if __name__ == '__main__':
	path_to_file = os.path.join(os.path.dirname(__file__), 'data/rosalind_prot.txt')
	mrna_string = read_data(path_to_file)
	protein_string = get_protein_string(mrna_string)
